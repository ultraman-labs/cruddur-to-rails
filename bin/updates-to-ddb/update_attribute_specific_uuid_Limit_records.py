...
# Prompt user for old_user_uuid, new_user_uuid, and number of records to update
...
# Query the table to retrieve the specified number of items with the matching user_handle
