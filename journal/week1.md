...
| * Endpoint for the notifications tab. Resolved issue of python "user_notification.py" module not being found. Extra blank space after \space       extension was the issue |
