...
<p> --- <br>  
   ...
   <h4>Confirming that, after authenticating, the preferred user name atribute from Cognito was passed onto the Cruddur app.
   ![Preferred User](../_docs/assets/week3/preferredusername.png)</h4>
