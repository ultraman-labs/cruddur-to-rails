...
class AddDeviseToUsers < ActiveRecord::Migration[7.1]
  def self.up
    change_table :users do |t|
      ...
      # Removed the line to add an email column, as it already exists
  ...
  def self.down
    # Define how to revert the changes made in up.
    # Note: Devise fields will be removed only if they exist.
